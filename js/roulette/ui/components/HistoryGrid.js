...
export default class HistoryGrid {
    ...
    renderRow(spin) {
        ...
        tr.innerHTML = `
            <td class="data-cell w-[8%] text-gray-400 border-white/10 text-xs font-mono bg-black/40">${spin.spinNumber}</td>
            ...
            ${this.state.gridSettings.oe ? `<td class="data-cell w-[18%] ${cOE}">${zTxt || (spin.oe === 'Odd' ? (this.isCompactMobile ? 'O' : 'Odd') : (this.isCompactMobile ? 'E' : 'Even'))}</td>` : ''}
