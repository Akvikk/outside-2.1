...
/**
 * RouletteState: The Single Source of Truth for Roulette memory.
 * No DOM references or heavy math logic here. Just pure data.
 */
export default class RouletteState {
    constructor() {
        ...
        // Initialize pattern filters based on config defaults
        PATTERN_CONFIG.forEach(p => {
            this.activeFilters[p.key] = p.default !== false;
        });
